...
export default function Chat() {
  ...
  const {
    ...
    pageId: params?.instagram_id!,
    pageAccessToken: "EAAOaM0NcAc4BQLY023QNooPPSqeZBClkV5lwKz5nhY3JHVojvd3FcRajZAitTfYerH7SZC0f0IRC7ZBlD1wYliRf1f9xjv9uGQ8visPQX25rXo0UZC1FLr4ZCrZCCCO4etiRjiR68bWl5v8g7ZBCRioUvdYFOEDpsDieIMWlRDCOyTic0p6UPsh2EExCK5KtAd9szZCByLi1o",
  });
            ...
            <div className="flex flex-col p-5 box box--stacked">
              ...
              <div
                className={clsx([
                  ...
                  "[&simplebar-content]:p-0 [&simplebar-track.simplebar-vertical]:w-[10px] [&simplebar-track.simplebar-vertical]:mr-0.5 [&simplebar-track.simplebar-verticalsimplebar-scrollbar]:before:bg-slate-400/20",
                ])}
                ref={scrollableRef}
              >
                <div className="flex flex-col gap-3.5 py-5 px-3">
                  {take(messages.fakeMessages(), 9).map((faker, fakerKey) => (
                    <div
                      key={fakerKey}
                      className={clsx([
                        "max-w-[85%] sm:max-w-none relative mr-auto group [&.right]:mr-0 [&.right]:ml-auto flex items-end gap-3 [&.right]:flex-row-reverse",
                        { right: [0, 0, 1, 1, 1][random(0, 5)] },
                      ])}
                    >
                          ...
                          (random(0, 1) ? (
                            ...
                            <div className="mt-3 mb-4 w-64 h-32 overflow-hidden rounded-lg image-fit group-[.right]:ml-auto">
                              <ImageZoom
                                ...
                                src={"http://localhost:5174/src/assets/images/projects/project4-400x400.jpg"}
                              />
                            </div>
                          ))}
